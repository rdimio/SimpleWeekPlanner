...
public class MailService {
    ...
    public void sendConfRegMail(UserDto userDto) {
        try {
            sendMail(userDto.getEmail(), String.format("to confirm the registration go to http://localhost:8189/mycreation/registration/confirm/%d%n", userDto.getToken()), messageBuilder.buildUserEmail(userDto));
